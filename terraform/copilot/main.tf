# Copilot infrastructure — ephemeral resources for SRE Copilot development.
#
# These resources are created when working on the Copilot and destroyed after.
# The Copilot needs its own DSQL cluster (separate from the monitored cluster)
# for its state store and workflow persistence, plus a Bedrock Knowledge Base
# for RAG retrieval.
#
# Usage:
#   tdeploy infra apply-copilot
#   tdeploy infra destroy-copilot
