...
echo "✅ ACM certificates configured"
echo ""
...
echo "  • Docker Images: $([ "$BUILD_IMAGES" = "true" ] && echo "Built for $TARGET_ARCH" || echo "Assumed existing")"
echo ""
echo "📁 Files Created:"
echo "  • terraform-outputs.json (Terraform metadata)"
echo "  • client-vpn.ovpn (VPN configuration)"
