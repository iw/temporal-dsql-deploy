...
Usage:
    ...
    uv run python dsql-tests/copilot/stress_workflows.py --rate 20 --duration 10
    uv run python dsql-tests/copilot/stress_workflows.py --address copilot-temporal:7233
"""
...
class StressWorkflow:
    ...
    async def run(self, work_ms: int = 100) -> str:
        ...
        # Step 3: short timer (exercises timer queue)
...
async def main() -> None:
    ...
    print("📊 RESULTS")
    print("=" * 60)
    print(f"Duration:    {_format_duration(total_time)}")
