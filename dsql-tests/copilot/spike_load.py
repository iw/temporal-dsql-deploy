...
Usage:
    uv run python dsql-tests/copilot/spike_load.py
    uv run python dsql-tests/copilot/spike_load.py --base-rate 5 --spike-rate 50
    uv run python dsql-tests/copilot/spike_load.py --spike-duration 60 --calm-duration 120
"""
...
class SpikeWorkflow:
    ...
    async def run(self, work_ms: int = 150) -> str:
        # Three activities = three state transitions per workflow
